...
import { NEW_COOKED_ORDER, NEW_ORDER_UPDATE, NEW_PENDING_ORDER, PUB_SUB } from 'src/common/common.string';
...
////////////////////
  ...
  async editOrder(
    ...
    try {
      ...
      await this.orders.save({ // save() method doesn`t return the whole entity
          id: orderId, 
          status,
        })
