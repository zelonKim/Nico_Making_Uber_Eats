...
describe('UsersService', () => {
  ...
  describe('editProfile', () => {
    it("should change email", async() => {
        ...
        verificationsRepository.create.mockReturnValue(newVerifications)
        verificationsRepository.save.mockResolvedValue(newVerifications)
        ...
        expect(mailService.sendVerificationEmail).toHaveBeenCalledWith(newUser.email, newVerifications.code)
      })
  ...
  describe('verifyEmail', () => {
    ...
    it('should fail on exception', async() => {
      ...
      const result = await service.verifyEmail("")
      expect(result).toEqual({ ok: false, error: 'Can not verify email' })
    })
  });
});
